...
case_study = 'scenario_clever_cost_EV_NG_FUELCELL'  # Give here the name of the case study for
# deterministic run
expl_text = 'clever_cost_EV_NG_FUELCELL'  # Give here explanation text to describe the
# case study
